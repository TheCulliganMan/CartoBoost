...
| Do graph series need heterogeneity routing, high-order propagation, long-short context, gated temporal state, or spatial-shift robustness? | `STGormerForecaster`, `STGformerForecaster`, `LSTTNForecaster`, `SpatialTemporalGraphGatedTransformerForecaster`, or `SpatialShiftGraphonMoEForecaster` | [Paper Graph Transformers](forecasting-models/graph-spatiotemporal.md#paper-graph-transformer-profiles) |
