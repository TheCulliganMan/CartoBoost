...
| [Paper Graph Transformers](graph-spatiotemporal.md#paper-graph-transformer-profiles) | `STGormerForecaster`, `STGformerForecaster`, `LSTTNForecaster`, gated graph Transformer, and spatial-shift graphon MoE. | Use when the architecture's heterogeneity, high-order, long-short, gated, or shift mechanism is the hypothesis being tested. |
