...
| [CartoBoost HinSAGE Models](cartoboost-hinsage.md) | Node types and relation triples are part of the modeling contract. |

Keep direction explicit. A source-to-target fact is usually not the same as
the reverse fact.

See [Graph Features](../../graph-features.md) for the contract details,
directionality options, artifacts, and failure modes.
